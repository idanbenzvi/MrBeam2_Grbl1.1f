...
#define DEFAULT_INVERT_PROBE_PIN 0 // false
  ...
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 25 // msec (0-254, 255 keeps steppers enabled)
  #define DEFAULT_STATUS_REPORT_MASK 1 //mpos - fix by Idan
  ...
  #define DEFAULT_HOMING_PULLOFF 1.0 // mm
  #define DEFAULT_LASER_MODE 1 // yes

#endif

#ifdef DEFAULTS_MRBEAMII
  //Mr Beam II - default settings
  #define DEFAULT_X_STEPS_PER_MM 100.0
  #define DEFAULT_Y_STEPS_PER_MM 100.0
  #define DEFAULT_Z_STEPS_PER_MM 100.0
  #define DEFAULT_X_MAX_RATE 5000.0 // mm/min
  ...
  //dimensions
  #define DEFAULT_X_MAX_TRAVEL 500
  #define DEFAULT_Y_MAX_TRAVEL 400
...
#define DEFAULT_INVERT_PROBE_PIN 0 // false
  ...
  #define DEFAULT_DIRECTION_INVERT_MASK ((1<<X_AXIS))
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 25 // msec (0-254, 255 keeps steppers enabled)
  #define DEFAULT_STATUS_REPORT_MASK 1 //mpos - fix by Idan *** may be 31 ***
  #define DEFAULT_JUNCTION_DEVIATION 0.02 // mm
  #define DEFAULT_ARC_TOLERANCE 0.002 // mm
  #define DEFAULT_DECIMAL_PLACES 3
  #define DEFAULT_REPORT_INCHES 0 // false
