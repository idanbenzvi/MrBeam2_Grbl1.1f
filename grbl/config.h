...
#define DEFAULTS_MRBEAM // insted of : DEFAULTS_GENERIC
#define CPU_MAP_ATMEGA328P // Arduino Uno CPU - idan:not changed to the older MRBEAM328P since there are no differences in setups
